...
def load_unWords():
    with open('C:\\Users\\user\\Desktop\\SAVE THESE\\temporary_save.txt', encoding='utf-8') as temp_file:
        c = temp_file.read()
        textArea2.delete('1.0', END)
...
def langensch_DEEN():
##    out1 = 'Übersicht aller Übersetzungen'
##    out2 = '(Für mehr Details die Übersetzung anklicken/antippen),'
##    out3 = 'Femininum | feminine'
##    out4 = 'Maskulinum | masculine'
...
root = Tk()
root.title("TbLLT: Text-based Language Learning Tool> PAIR is DE-->EN")
...
def notebook():
    ...
    label = Label(wnd, width=68, height=2, fg='white', bg='#B0C4DE', padx=5)
...
def save_notes():
    ...
    ctt = cnt+'\n'
    with open('C:\\Users\\user\\Desktop\\SAVE THESE\\notes.txt', 'w+', encoding='utf-8') as notes_file:
...
list1 = Listbox(rWind2a, width=65, height=20)
list1.pack(side=TOP)
...
btnhide5 = Button(midWind3, text="Example sentences ➡", font=('Arial', 12, 'bold'),width=24, relief='flat', bg='#B0C4DE')
...
dbtext = ScrolledText(rWind2c, width=50, height=6)
...
btn1 = Button(frame1a, text="", width=13, relief='flat', bg='#B0C4DE')
