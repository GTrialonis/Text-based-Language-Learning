...
def openfile():
    ...
    defaultextension='txt', filetypes=(('All files', '*.*'), ('Text files', '*_Vocab.txt')))
...
def translate_this(event):
    ...
    if canMoveToNextWord == True:
        ...
        if user_input in chunk_right:
            ...
            textArea1.tag_add("start", "3.33", "3.90") # for user input above
...
# --------------------------------------
##textArea = Text(frame1, width=300, height=30)
##textArea.pack()
##textArea.insert(END, fl_name)
#--------------------------------------
